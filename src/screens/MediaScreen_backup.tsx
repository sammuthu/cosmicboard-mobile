...
// TODO: Re-enable these imports after fixing expo-constants issue
...
export default function MediaScreen({ route }: Props) {
  ...
  const requestPermissions = async () => {
    // TODO: Re-enable after fixing expo-constants issue
    ...
    //   );
    // }
    console.log('Permissions request disabled temporarily');
  };
  ...
  const handleUpload = () => {
    Alert.alert(
      ...
      'Media upload functionality is being fixed and will be available soon.',
      [
  ...
  const takePhoto = async () => {
    // TODO: Re-enable after fixing expo-constants issue
    console.log('Camera functionality disabled temporarily');
  ...
  const pickImage = async () => {
    // TODO: Re-enable after fixing expo-constants issue
    console.log('Image picker disabled temporarily');
  ...
  const pickDocument = async () => {
    // TODO: Re-enable after fixing expo-constants issue
    console.log('Document picker disabled temporarily');
    // try {
  ...
  const pasteScreenshot = async () => {
    // TODO: Re-enable after fixing expo-constants issue
    console.log('Clipboard paste disabled temporarily');
    // if (projectId === 'all') {
